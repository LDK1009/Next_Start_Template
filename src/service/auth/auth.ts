...
////////// 로그인
export async function signIn(redirectTo: string = `${process.env.NEXT_PUBLIC_API_BASE_URL}/auth/sign-in/success`) {
...
export async function getCurrentUserMetadata() {
  try {
    ...
    throw new Error("유저 메타데이터 정보 가져오기 실패");
  }
}
